...
public class Bootcamp {
	...
	public Bootcamp(String nome, String descricao, Set<Dev> devsInscrintos, Set<Conteudo> conteudos) {
		this.nome = nome;
	...
	@Override
	public int hashCode() {
		return Objects.hash(conteudos, dataFinal, dataInicial, descricao, devsInscrintos, nome);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(conteudos, other.conteudos) && Objects.equals(dataFinal, other.dataFinal)
				...
				&& Objects.equals(devsInscrintos, other.devsInscrintos) && Objects.equals(nome, other.nome);
	}
